...
type CourseTab = 'official' | 'community';

interface NormalRunFilterStore {
...
export const useNormalRunFilterStore = create<NormalRunFilterStore>()(
  persist(
    (set) => ({
      searchKeyword: '',
